...
Nếu Server và Client **không cùng máy**, cần đổi `localhost` thành IP của máy chạy Server tại các file sau trong Client:

| File | Dòng cần sửa |
|---|---|
| `Client/src/main/java/com/auction/client/network/ApiService.java` | `private final String BASE_URL = "http://<SERVER_IP>:8080/api";` |
| `Client/src/main/java/com/auction/client/controllers/BiddingRoomController.java` | `private final String BASE_URL = "http://<SERVER_IP>:8080/api";` |
